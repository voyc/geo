...
function setprofile() {
	...
	$profileid = 0;
	$name = 'query-profile';
	$sql = "select id from geosketch.profile where userid = $1";
	$params = array($userid);
	...
	if ($profileid) {
		$name = 'update-profile';
		$sql = "update geosketch.profile set gender=$2, photo=$3, phone=$4 where id = $1";
		...
		$name = 'insert-profile';
		$sql = "insert into geosketch.profile (userid, gender, photo, phone) values ($1,$2,$3,$4)";
